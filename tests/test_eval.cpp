...
// move. Everything the evaluation knows is defined relative to a side, so a
// position and its mirror have to score exactly alike.
std::string MirrorSfen(const std::string& sfen) {
